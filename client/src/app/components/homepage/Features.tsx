...
export default function Features() {
    return(
        ...
        <h5 className = "text-lg md:text-xl text-stats font-semibold text-center mb-2">WHAT DO WE OFFER?</h5>
        <h2 className=" text-3xl md:text-4xl text-brandHeading font-bold text-center mb-6">Everything you need</h2>
    ...
    return(
        <>
            <div className="max-w-sm lg:max-w-md px-8 py-10 flex flex-col items-center gap-4">
                    ...
                    <h3 className="text-xl md:text-2xl font-medium text-stats">{title}</h3>
